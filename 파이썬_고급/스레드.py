# 하나의 Application내에서 여러개의 일을 동시에  수행하는 것

from simple_colors import * # 터미널 출력 시 컬러를 지원하기 위해
import threading            #멀티 스레드를 지원하기 위해서
import time                 #sleep을 사용하기 위해, 주어진 시간 만큼 해당 스레드의 잠재움
import random               #난수 발생
...
if __name__ == "__main__":  # main thread 흐름을 타는 시작점
    ...
    wizard = Character(2, 20, 0.5, 0.9, 80, 55, name2)  # 물공,마공, 물방, 마방, 물적,마적,체력,궁극기
